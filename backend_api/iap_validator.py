...
class IapValidator:
    ...
    def validate_apple_receipt(receipt: str, bundle_id: str) -> Optional[Dict]:
        ...
        """
        url = os.getenv(
            "APPLE_RECEIPT_URL", IapValidator.APPLE_SANDBOX_URL
        )
        ...
        try:
            ...
            receipt_info = data.get("latest_receipt_info") or data.get(
                "receipt", {}
            ).get("in_app", [])
            ...
            return {
                ...
                "expiry_date": datetime.fromtimestamp(expires_date_ms / 1000)
                if expires_date_ms
                else None,
                "is_valid": True,
            }
